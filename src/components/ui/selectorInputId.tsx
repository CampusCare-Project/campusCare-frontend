...
type SelectorInputProps<T> = {
  ...
  /**
   * For Robot Framework / Appium locator.
   * Example:
   * testID="admin-technician-select"
   * optionTestIDPrefix="admin-technician-option"
   *
   * Robot:
   * Click Element    accessibility_id=admin-technician-select
   * Click Element    accessibility_id=admin-technician-option-0
   */
  testID?: string;
...
export function SelectorInput<T>({
  ...
  testID,
  accessibilityLabel,
  optionTestIDPrefix = "selector-option",
    ...
    <View style={styles.container}>
      ...
      <View style={[styles.inputWrapper, disabled && styles.disabledInput]}>
        ...
        {loading ? (
          <ActivityIndicator
            ...
            accessibilityLabel={testID ? `${testID}-loading` : undefined}
            size="small"
          />
        ) : null}
      </View>
      ...
      {error ? (
        <Text
          ...
          accessibilityLabel={testID ? `${testID}-error` : undefined}
      ...
      {open && !disabled ? (
        <View
          ...
          accessibilityLabel={testID ? `${testID}-dropdown` : undefined}
          ...
          {loading ? (
            <View style={styles.emptyBox}>
              <Text
                ...
                accessibilityLabel={testID ? `${testID}-loading-text` : undefined}
            ...
            <View style={styles.emptyBox}>
              <Text
                ...
                accessibilityLabel={testID ? `${testID}-empty-text` : undefined}
                style={styles.emptyText}
              >
                {emptyText}
              </Text>
            ...
            <FlatList
              ...
              renderItem={({ item, index }) => {
                ...
                const optionTestID = `${optionTestIDPrefix}-${index}`;
                ...
                return (
                  ...
                  >
                    <View style={styles.optionContent}>
                      <Text
                        testID={`${optionTestID}-label`}
                        accessibilityLabel={`${optionTestID}-label`}
                      ...
                      {getDescription ? (
                        <Text
                          testID={`${optionTestID}-description`}
                          accessibilityLabel={`${optionTestID}-description`}
                    ...
                    {selected ? (
                      <Text
                        testID={`${optionTestID}-selected`}
                        accessibilityLabel={`${optionTestID}-selected`}
